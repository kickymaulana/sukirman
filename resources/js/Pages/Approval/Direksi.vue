...
interface MR { id: number; mr_number: string; factory: string; user: { name: string }; created_at: string }
...
<template>
    <Head title="Direksi - SUKIRMAN" />
    <div class="layout">
        <var-app-bar title="Approval Direksi" title-position="center">
